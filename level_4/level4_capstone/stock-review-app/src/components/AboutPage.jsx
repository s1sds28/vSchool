...
const AboutPage = () => {
  return (
    <div className="about-page">
      ...
      <p>The Stock Research application retrieves the highest and lowest trading prices from the previous day for a specific stock. Below, I've outlined a case for your reference</p>
